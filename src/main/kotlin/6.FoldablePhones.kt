// https://developer.android.com/codelabs/basic-android-kotlin-compose-kotlin-fundamentals-practice-problems#6
...
class FoldablePhdone(var isFolded: Boolean = false) : Phone() {
